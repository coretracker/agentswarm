...
export default function ProviderSetupTerminalPage() {
    ...
    <Flex vertical style={{ height: "100%", minHeight: 0, overflow: "hidden" }}>
      ...
      >
        <Flex vertical gap={0} style={{ minWidth: 0 }}>
          <Typography.Text strong style={{ color: token.colorText }}>
            Provider Setup Terminal
          </Typography.Text>
          <Typography.Text type="secondary" style={{ fontSize: 12 }}>
            Shared Codex and Claude setup. Terminal font: Ctrl/⌘ + +/− (numpad works); Ctrl/⌘ + 0 resets.
          </Typography.Text>
        </Flex>
      ...
      <div style={{ flex: 1, minHeight: 0, padding: 8, background: "#1e1e1e" }}>
        <TaskInteractiveTerminalView
          webSocketPath="/settings/providers/setup/terminal"
          disconnectHint="Open the setup terminal again to start a new session."
        />
      </div>
    </Flex>
  );
